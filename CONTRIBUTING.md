...
3. Open a [new issue](github.com/rosariopfernandes/FirebaseCompose/issues/new) to discuss your changes
...
git remote add upstream https://github.com/rosariopfernandes/FirebaseCompose
```
